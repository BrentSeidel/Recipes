...
I haven't made this yet and will update once I do.
\subsection{Ingredients}
\begin{itemize}
  ...
  \item 3 tbsp white grape juice
  \item 1 large egg
  \item A small amount of egg white (to seal the cannolis)
\end{itemize}
\subsection{Procedure}
\begin{itemize}
  ...
  \item Move the dough to a floured surface and knead until smooth (about 3-4 minutes)
  \item Wrap dough in plastic wrap and refrigerate for at least 1 hour (it can be left overnight)
  \item Lightly coat dough with flour and roll out onto a floured surface to no more than 1/8 inch thick (a pasta machine could also be used)
  \item Use a 4 inch round cookie cutter to cut circles from the dough
  \item Wrap each circle around a cannoli tube and seal with a little egg white
...
The filling can keep a couple days refrigerated in an airtight container.  Feel free to experiment with this.

I haven't made this yet, and will update when I do.
\subsection{Ingredients}
\begin{itemize}
  \item 3/4 cup Ricotta Cheese
  \item 1/2 cup powdered sugar
  \item t tsp orange zest
