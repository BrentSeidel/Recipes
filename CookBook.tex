...
This is a crust for making the shell for tarts.
\subsection{Ingredients}
\begin{itemize}
...
\begin{itemize}
  ...
  \item Break off dough and press into an oiled and floured tart/pie pan (should be no more than 3-4mm thick).
  ...
  \item Bake another 5-10 minutes or until pastry is golden (you can omit step this if the filling will need to be baked).
