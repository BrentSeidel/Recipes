...
\begin{itemize}
  ...
  \item Repeat (1:O2) until the end of the strands is reached.
...
\begin{itemize}
  ...
  \item Repeat (alternating 1:O2 and 3:O2) until the end of the strands is reached.
  \item Squeeze the last end together.
\end{itemize}
...
\begin{itemize}
  ...
  \item Repeat (1:O2,U3,O4) until the end of the strands is reached.
  \item Squeeze the last end together.
\end{itemize}
