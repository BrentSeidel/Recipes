...
\section{Garlic Cheese Rolls}
\label{bread:GarlicCheese}
Many variations of this recipe are possible.  For example, replacing the garlic with orange zest and using a chocolate spread instead of cheese creates a sweet chocolate roll.  You could make cinnamon rolls based on this, or use your imagination.
\subsection{Ingredients}
\begin{itemize}
  \item 3/4 cup (182g) water
  \item 1tbsp (5g) oil
...
\begin{itemize}
  ...
  \item Spread the shredded cheese on the dough.
  \item Roll the dough and cheese up like you were making cinnamon rolls.
  \item Place some parchment paper on a baking pan.
  \item Slice the roll into 2-3cm segments and place on baking pan.
...
\end{itemize}
If you are blind baking, bake at 37f\degree{}F for 10 minutes or so will work.
