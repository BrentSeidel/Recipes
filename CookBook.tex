...
\subsection{Ingredients}
\begin{itemize}
  \item Whites from 4 large eggs (possibly leftovers from making Creme Patisserie \ref{extra:CremePat}) at room temperature
...
\begin{itemize}
  ...
  \item 1 tsp raspberry powder
\end{itemize}
\subsection{Procedure}
\begin{itemize}
  \item preheat oven to 200\degree{}F
  \item whip the eggs and cream of tartar at medium speed until foamy
  ...
  \item continue whipping until stiff peaks are reached.
  \item pipe meringue onto a cookie sheet
  \item bake until dry and can easily be removed (about 3 hours, but this may be too long.)
\end{itemize}
%----------------------------------------------------------
