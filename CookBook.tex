...
\begin{itemize}
  ...
  \item Roll each lump into long strand.
  \item Lay the strands side-by-side and squeeze one end together.
  \item Move strand 1 over strand 2 and strand 3 over strand 4 ($[\sigma^{-1}_1\sigma^{-1}_3]$).
  \item Then move strand 2 under strand 3 ($\sigma_2$).
  \item Squeeze the last end together.
\end{itemize}
...
\begin{itemize}
  ...
  \item Roll each lump into long strand.
  \item Lay the strands side-by-side and squeeze one end together.
  \item Move the top and middle strands over the next strands, and under the next strand ($[\sigma^{-1}_1 \sigma^{-1}_3]$).
  \item Move the second and fourth strands over the next strand ($[\sigma_2\sigma_4]$).
