...
This is a real easy way to make some comfort food.  To make a pot pie, top with a pastry crust  or biscuit dough (such as from section \ref{quick:Buttermilk}) instead of mashed potatoes.  The measurements are not critical.  Feel free to experiment and find something that you like.
\subsection{Ingredients}
\begin{itemize}
...
\begin{itemize}
  ...
  \item Whisk the egg whites until they begin to foam.
  ...
  \item Continue whisking until stiff peaks form (this will take longer for carton egg whites - after 20 minutes, you might decide that separating eggs isn't so bad after all; the thing that kept me going was noticing the slow changes in the consistency of the mix).
...
I tried making orange curd by replacing the lemon juice and zest with orange juice and zest.  The result was orange flavored scrambled eggs.  I've read that lemon juice has more pectin than orange juice, so that may be the difference.  By replacing $\frac{1}{2}$ cup of the lemon juice with orange juice, I was able to get a reasonable result.

\subsection{Ingredients}
\begin{itemize}
  \item $\frac{3}{4}$ cup fresh lemon juice (up to $\frac{1}{2}$ cup can be replaced by orange juice to make an orange curd)
...
\begin{itemize}
  ...
  \item Heat with medium heat until mixture starts to thicken and gets to a boil (15-20 minutes, or so).  Whisk continually while heating to keep the eggs from curdling.
...
This is a modification of the Lemon Curd recipe to use raspberries and/or blackberries.

\subsection{Ingredients}
\begin{itemize}
  \item 265g frozen raspberries and/or blackberries
